<template>
    <ul class="pc-menu__center flex flex-wrap gap-12 relative" role="menubar" aria-label="Main menu">
        <li role="none" class="pt-[20px] pb-[20px] font-medium"><router-link role="menuitem"
                to="/dashboard">Dashboard</router-link></li>
        <li role="none" class="pt-[20px] pb-[20px] font-medium"><router-link role="menuitem"
                to="/pages">Pages</router-link></li>

        <li class="pc-menu__item--dropdown relative pt-[20px] pb-[20px]" role="none" @mouseenter="onMouseEnter"
            @mouseleave="onMouseLeave">
            <button class="pc-menu__button" aria-haspopup="true" aria-expanded="false">Catalog</button>
            <ul class="pc-menu__dropdown hidden flex flex-wrap gap-3 py-[15px] px-[20px] rounded-b-[10px] -left-5 absolute top-16 bg-slate-200 the"
